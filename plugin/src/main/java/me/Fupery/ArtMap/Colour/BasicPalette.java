...
public class BasicPalette implements Palette {
	public final ArtDye
			...
			WHITE = new BasicDye(DYE_WHITE.get(), "WHITE", 14, ChatColor.WHITE, Material.WHITE_DYE),
			...
			BLUE = new BasicDye(DYE_BLUE.get(), "BLUE", 25, ChatColor.BLUE, Material.BLUE_DYE),
			BROWN = new BasicDye(DYE_BROWN.get(), "BROWN", 26, ChatColor.DARK_RED, Material.BROWN_DYE),
			...
			BLACK = new BasicDye(DYE_BLACK.get(), "BLACK", 29, ChatColor.DARK_GRAY, Material.BLACK_DYE),
